...
<div id="page" class="container">
	<div id="header">
		...
		<div id="menu">
			...
			<ul>
				<li class="current_page_item"><a href="javascript:document.indexpost.submit();" accesskey="1" title="">主页</a></li>
				<li><a href="javascript:document.blogpost.submit();" accesskey="2" title="">博客</a></li>
